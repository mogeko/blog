...
然后密匙就已经生成完毕了。记下密匙ID (就是形如 2D932B9D2800D938 的一串 16 进制数)

```bash
gpg: 密钥 2D932B9D2800D938 被标记为绝对信任
gpg: 吊销证书已被存储为‘/home/mogeko/.gnupg/openpgp-revocs.d/DC4E79EFEE5E224A20E9013A2D932B9D2800D938.rev’
公钥和私钥已经生成并被签名。

pub   rsa2048 2019-05-16 [SC] [有效至：2021-05-15]
      DC4E79EFEE5E224A20E9013A2D932B9D2800D938

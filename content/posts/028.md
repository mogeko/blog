...
<img src="https://mogeko.github.io/blog-images/028/get_token.png" alt="Get Token">

然后记下 Token 的值，也就是我打码的那一部分 (一定要记下来，因为离开这个页面之后就没有机会再次查看了)

<img src="https://mogeko.github.io/blog-images/028/get_token_api.png" alt="Get Token">

### 设置 Travis CI

接着来到 [Travis CI](https://travis-ci.org/account/repositories)，使用 GitHub 帐号登录；然后为 **`Blog`** 仓库打上 ☑，然后点 `setting`。

<img src="https://mogeko.github.io/blog-images/028/set_travis_1.png" alt="设置 Travis CI">
...
<img src="https://mogeko.github.io/blog-images/028/set_travis_2.png" alt="设置 Travis CI">
...
<img src="https://mogeko.github.io/blog-images/028/run_travis.png" alt="Travis CI 部署">
